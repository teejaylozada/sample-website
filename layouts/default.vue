        ...
        <div class="md:hidden relative" ref="dropdownContainer">
          ...
          <div v-if="isMenuOpen" ref="dropdownMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-md z-10 border border-gray-300 overflow-hidden">
            <div class="py-1 bg-gray-900">
              <NuxtLink to="/" class="block px-4 py-2 text-gray-500 hover:bg-gray-100 flex items-center transition duration-300">
                <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h18M4 10h16M4 16h16"></path>
                </svg>
                Home
              </NuxtLink>
              <NuxtLink to="/about" class="block px-4 py-2 text-gray-500 hover:bg-gray-100 flex items-center transition duration-300">
                <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                </svg>
                About
              </NuxtLink>
              <NuxtLink to="/services" class="block px-4 py-2 text-gray-500 hover:bg-gray-100 flex items-center transition duration-300">
                <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                </svg>
                Services
              </NuxtLink>
              <NuxtLink to="/contact-us" class="block px-4 py-2 text-gray-500 hover:bg-gray-100 flex items-center transition duration-300">
                <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
